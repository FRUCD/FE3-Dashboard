...
#define BS_IOPORT_0_VAL ((const uint8 CYFAR *)0x480006F4u)

/* IOPORT_4 Address: CYDEV_PRTDSI_PRT4_BASE Size (bytes): 7 */
#define BS_IOPORT_4_VAL ((const uint8 CYFAR *)0x480006FCu)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x4800074Cu)
...
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x4800075Cu)

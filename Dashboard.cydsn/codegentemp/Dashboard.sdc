...
# Date: Sat, 22 Feb 2020 20:56:02 GMT
#set_units -time ns
...
create_generated_clock -name {BLED_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 241 481} [list [get_pins {ClockBlock/dclk_glb_1}]]
